    ...
    <div className="flex min-w-0 flex-col gap-2">
      ...
      <Listbox value={selectedValues} onChange={onChange} multiple>
        <div className="relative">
          <Listbox.Button className="relative h-11 w-full cursor-default rounded-md border border-white/10 bg-neutral-900 px-3 py-2 pr-10 text-left shadow-inner shadow-black/20 transition hover:border-white/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300">
